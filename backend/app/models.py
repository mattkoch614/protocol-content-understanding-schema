...
class DocumentAnalysisRequest(BaseModel):
    ...
    document_url: Optional[str] = Field(
        None, description="URL of the document to analyze"
    )
    document_name: Optional[str] = Field(
        None, description="Name of the uploaded document"
    )
...
class DocumentAnalysisResponse(BaseModel):
    ...
    document_id: str = Field(
        ..., description="Unique identifier for the analyzed document"
    )
    ...
    raw_result: Optional[Dict[str, Any]] = Field(
        None, description="Raw response from Azure Content Understanding"
    )
...
class ProtocolMetadata(BaseModel):
    ...
    amendment_number: Optional[str] = Field(
        None, description="Amendment number if applicable"
    )
