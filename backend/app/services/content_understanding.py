...
class ContentUnderstandingService:
    ...
    async def analyze_document_from_url(
        ...
        """
        Analyze a document from a URL using Azure Content Understanding AI.
        ...
        try:
            ...
            # Build request body with document URL
            request_body = {"inputs": [{"url": document_url}]}
    ...
    async def analyze_document(
        ...
        try:
            ...
            request_body = {"inputs": [{"url": test_file_url}]}
    ...
    async def _poll_for_result(
        ...
        raise Exception(
            f"Analysis timed out after {max_retries * retry_interval} seconds"
        )
